...
import (
	...
	consts "github.com/Basic-Components/pub-sub-broker/consts"
	loadconfig "github.com/Basic-Components/pub-sub-broker/loadconfig"
	proxy "github.com/Basic-Components/pub-sub-broker/proxy"
...
func makeConfig() loadconfig.Config {
	...
	flag.StringVar(&stackName, "stack_name", "", "使用该中间人的堆名")
...
func main() {
	...
	}).Info("Broker for Stack [" + config.StackName + "] start !")
	log.WithFields(log.Fields{
		consts.TYPE: consts.NAME,
